...
const APIs = {
  ...
  CreateAPI: (Redux, close) => {
    API.Content.Sidebar.Main.Event.CreateAPI({
			data: {
        basic_info: {
  ...
  RetrieveAPI: (Redux, id) => {
    API.Content.Sidebar.Main.Event.RetrieveAPI({id})
    .then(response => {
      // console.log(response.data);
      const serverResponse = response.data;
  ...
  UpdateAPI: (Redux, id, close) => {
    API.Content.Sidebar.Main.Event.UpdateAPI({
      id,
			data: {
        basic_info: {
          title: Redux.state.FormObject.FormValue.title,
  ...
  DeleteAPI: (Redux, id, close) => {
    API.Content.Sidebar.Main.Event.DeleteAPI({id})
    .then(response => {
      // console.log(response.data);
      const serverResponse = response.data;
