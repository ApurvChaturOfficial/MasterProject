...
import { Create } from '../aSample1/extra/Component';
import APIs from './extra/APIs';
import { Delete, List, Retrieve, Update } from './extra/Component';
import { Action } from './extra/State';

const Sample3 = ({ Redux1 }) => {
  // Normal Variable
  const close1 = useRef()
  const close2 = useRef()
  const close3 = useRef()
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.Sample3State),
  ...
  return (
    <LCRUD 
      ...
      close4={close4}
      header={{
        title: "Welcome to Sample 3 Section ! 🎉",
        subTitle: "You are doing very well.",
        next: FinalRouteName.Content.Sidebar.Main.Sample4Route,
        breadcrumb: "Sample 3"
      }}
      access={{
        name: "Sample 3",
