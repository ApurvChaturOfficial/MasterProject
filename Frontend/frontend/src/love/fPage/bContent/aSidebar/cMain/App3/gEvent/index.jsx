...
const Event = ({ Redux1 }) => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.EventState),
  ...
  return (
    <LCRUD 
      ...
      close4={close4}
      header={{
        title: "Welcome to Event Section ! 🎉",
        subTitle: "You are doing very well, create an elegant event section for your career gallery.",
