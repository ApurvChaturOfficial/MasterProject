...
const Service = ({ Redux1 }) => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.ServiceState),
  ...
  return (
    <LCRUD 
      ...
      close4={close4}
      header={{
        title: "Welcome to Service Section ! 🎉",
        subTitle: "You are doing very well, create a striking service section for your career gallery.",
