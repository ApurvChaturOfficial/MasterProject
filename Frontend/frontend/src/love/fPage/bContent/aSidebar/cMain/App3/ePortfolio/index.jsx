...
const Portfolio = ({ Redux1 }) => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.PortfolioState),
  ...
  return (
    <LCRUD 
      ...
      close4={close4}
      header={{
        title: "Welcome to Portfolio Section ! 🎉",
        subTitle: "You are doing very well, create an elegant portfolio section for your career gallery.",
        next: FinalRouteName.Content.Sidebar.Main.PortfolioCardRoute,
