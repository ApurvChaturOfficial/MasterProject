...
const BlogCard = () => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.BlogCardState),
    ...
    <div class="content-wrapper">
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
          <div class="modal-content bg-light">
            <div class="modal-header">
              <h5 class="modal-title" id="modalFullTitle">BlogCard Create</h5>
              <button
                type="button"
                class="btn-close"
      ...
      <div class="modal fade" id="updateModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
          <div class="modal-content bg-light">
            <div class="modal-header">
              <h5 class="modal-title" id="modalFullTitle">BlogCard Update</h5>
              <button
                type="button"
                class="btn-close"
                data-bs-dismiss="modal"
