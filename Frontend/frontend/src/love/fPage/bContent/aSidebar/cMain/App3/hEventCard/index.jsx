...
import EventHandler from '../fPortfolioCard/extra/EventHandler';
...
const EventCard = ({ Redux1 }) => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.EventCardState),
  ...
  return (
    <LCRUD 
      ...
      editor2={editor2}
      header={{
        title: "Welcome to Event Card Section ! 🎉",
        subTitle: "You are doing very well, add impressive event cards to your career gallery.",
