...
const Experience = () => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.ExperienceState),
  ...
  return (
    <LCRUD 
      ...
      close4={close4}
      header={{
        title: "Welcome to Experience Section ! 🎉",
        subTitle: "You are doing very well, create an impressive experience section for your career gallery.",
