...
const APIs = {
  ...
  CreateAPI: (Redux, close) => {
    API.Content.Sidebar.Main.Portfolio.CreateAPI({
			data: {
        basic_info: {
  ...
  RetrieveAPI: (Redux, id) => {
    API.Content.Sidebar.Main.Portfolio.RetrieveAPI({id})
    .then(response => {
      // console.log(response.data);
      const serverResponse = response.data;
  ...
  UpdateAPI: (Redux, id, close) => {
    API.Content.Sidebar.Main.Portfolio.UpdateAPI({
      id,
			data: {
        basic_info: {
          title: Redux.state.FormObject.FormValue.title,
  ...
  DeleteAPI: (Redux, id, close) => {
    API.Content.Sidebar.Main.Portfolio.DeleteAPI({id})
    .then(response => {
      // console.log(response.data);
      const serverResponse = response.data;
