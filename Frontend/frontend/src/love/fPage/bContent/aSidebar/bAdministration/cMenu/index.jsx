...
const Menu = ({ Redux1 }) => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.MenuState),
  ...
  return (
    <LCRUD 
      ...
      close4={close4}
      header={{
        title: "Welcome to Menu Section !  🎉",
        subTitle: "You are doing very well, create a stunning menu section for your career gallery.",
        breadcrumb: "Menu"
      }}
			access={{
				name: "Menu",
