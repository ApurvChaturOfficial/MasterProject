      ...
      <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content bg-light">
          <div class="modal-header">
            <h5 class="modal-title" id="modalFullTitle">Role Create</h5>
            <button
              type="button"
              class="btn-close"
                  ...
                  <div class="card-body">
                    <form noValidate>
                      ...
                      <div class="mb-3">
                        ...
                        <div class="form-text text-danger">{Redux.state.FormObject.FormError.isActive}</div>
                      </div>
                    </form>
                  </div>
                </div>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form noValidate>
                      {/* Access */}
                      <div class="mb-3">
                        <label for="formFile" class="form-label">Access</label>
                        <div class="table-responsive text-nowrap">
                          <table class="table table-hover">
                            <thead>
                              <tr>
                            ...
                            <tbody class="table-border-bottom-0">
                              {Redux.state.RequiredObject.MenuList &&
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <input 
                                          ...
                                          onChange={event => EventHandlers.HandleInput(event, Redux, index)}
                                        />
                                      </td>
                                      <td>
                                        <input 
                        ...
                        <div class="form-text text-danger">{Redux.state.FormObject.FormError.access}</div>
                      </div>
                    </form>
                  </div>
                </div>
  ...
  return (
    <div class="modal fade" id="updateModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content bg-light">
          <div class="modal-header">
            <h5 class="modal-title" id="modalFullTitle">Role Update</h5>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
