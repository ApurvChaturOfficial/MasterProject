...
const AboutCreate = () => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.AboutCreateState),
	...
	// API Calls
	const APICalls = {
		AboutCreateAPICall: () => APIs.AboutCreateAPI(Redux, navigate)
	}
  ...
  useEffect(() => {
	...
	// Submit Render
	useEffect(() => {
		submitFormObject(Redux, APICalls.AboutCreateAPICall)
