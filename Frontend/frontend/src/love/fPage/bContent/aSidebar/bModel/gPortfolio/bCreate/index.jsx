...
const PortfolioCreate = () => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.PortfolioCreateState),
	...
	// API Calls
	const APICalls = {
		PortfolioCreateAPICall: () => APIs.PortfolioCreateAPI(Redux, navigate),
    PortfolioCardListAPICall: index => APIs.PortfolioCardListAPI(Redux, index),
	}
  ...
  useEffect(() => {
	...
	// Submit Render
	useEffect(() => {
		submitFormObject(Redux, APICalls.PortfolioCreateAPICall)
        ...
        <div class="row g-4">
          <div class="col-sm-12 col-xl-6">
            <div class="bg-light rounded h-100 p-4">
              ...
              <form>
                <div class="mb-3">
                  <label for="inputEmail3" class="col-sm-12 col-form-label">Portfolio Cards</label>
                  <Select 
