...
const PortfolioUpdate = () => {
	...
	// Redux
	const Redux = {
			state: useSelector((fullState) => fullState.PortfolioUpdateState),
	...
	const APICalls = {
		...
		PortfolioUpdateAPICall: () => APIs.PortfolioUpdateAPI(Redux, id, navigate)
	}
	...
	// Submit Render
	useEffect(() => {
			submitFormObject(Redux, APICalls.PortfolioUpdateAPICall)
      ...
      <Update 
          data = {{
            header: {
              ...
              back: {
                to: `${FinalRouteName.Content.Sidebar.Model.Portfolio.RetrieveRoute}/${id}`
              }
            },
            update: {
              inputs: {
