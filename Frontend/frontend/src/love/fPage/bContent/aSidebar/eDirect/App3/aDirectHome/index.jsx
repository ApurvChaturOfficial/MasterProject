...
import { Delete } from '../../../cMain/App3/aHome/extra/Component';
import APIs from './extra/APIs';
import { Create } from './extra/Component';
import EventHandler from './extra/EventHandler';
import { Action } from './extra/State';

const DirectHome = ({ Redux1 }) => {
  // Normal Variable
  const close1 = useRef()
  const close4 = useRef()
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.DirectHomeState),
  ...
  const APICalls = {
    ...
    UpdateAPICall: id => APIs.UpdateAPI(Redux, id),
    RetrieveAPICall: id => APIs.RetrieveAPI(Redux, id),
  ...
  useEffect(() => {
    submitFormObject(Redux, () => {
      ...
      APICalls.UpdateAPICall(Redux.state.FormObject.FormValue.id)
      :
      APICalls.CreateAPICall()
    })
          ...
          <div class="card">
            <div class="card-body">
              ...
              <button
                ...
                type="button" 
                onClick={event => validateFormObject(event, Redux, validateFormValues, "update")} 
              >Save changes</button>
