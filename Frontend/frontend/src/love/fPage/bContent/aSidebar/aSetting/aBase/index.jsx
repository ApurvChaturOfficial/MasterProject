...
const Base = ({ Redux1 }) => {
  ...
  // Redux
	const Redux = {
		state: useSelector((fullState) => fullState.BaseState),
  ...
  return (
    <LCRUD 
      ...
      close4={close4}
      header={{
        title: "Welcome to Base Section !  🎉",
        subTitle: "You are doing very well, create a stunning base section in your career gallery.",
        breadcrumb: "Base"
      }}
			access={{
				name: "Base",
