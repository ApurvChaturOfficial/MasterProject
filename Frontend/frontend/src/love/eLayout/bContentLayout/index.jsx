...
const ContentLayout = (props) => {
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class={Redux.state.ExtraObject?.OpenMenu ? "layout-container layout-menu-expanded" :  "layout-container"}>
          ...
          <div class="app-brand demo">
            ...
            <span class="layout-menu-toggle menu-link text-large ms-auto d-block d-xl-none" style={{cursor: "pointer"}} onClick={() => {
              Redux.dispatch({ type: Redux.action.ExtraObject, payload: {
                ...
                OpenMenu: !Redux.state.ExtraObject?.OpenMenu
              }})
            }}>
        ...
        <div class="layout-page">
          ...
          >
            <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-xl-none">
              <span class="nav-item nav-link px-0 me-xl-4" style={{cursor: "pointer"}} onClick={() => {
                Redux.dispatch({ type: Redux.action.ExtraObject, payload: {
                  ...Redux.state.ExtraObject,
                  OpenMenu: !Redux.state.ExtraObject?.OpenMenu
                }})
      ...
      <div class={Redux.state.ExtraObject?.OpenMenu ? "layout-overlay layout-menu-toggle d-block" : "layout-overlay layout-menu-toggle"}></div>
    </div>
	);
};
