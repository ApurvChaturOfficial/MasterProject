...
const database = () => {
    ...
    const DB_URL4 = "mongodb+srv://ApurvChaturNew:ApurvChatur@cluster0.degxoy1.mongodb.net/SofiePortfolioApp"
    ...
    process.env.ACTIVE_APP === 'SofiePortfolioApp' ? DB_URL = DB_URL4 :
